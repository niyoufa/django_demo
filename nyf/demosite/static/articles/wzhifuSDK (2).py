...
class WxPayConf_pub(object):
    ...
    APPSECRET = "c1902d4711c0f0b6b70ca346c40a422f"
    #受理商ID，身份标识
    MCHID = "1252933401"
    #商户支付密钥Key。审核通过后，在微信发送的邮件中查看
    KEY = "yePd1EMqjBHtkIrdrJs0sGtaEjtzb2l0"
   

    #=======【异步通知url设置】===================================
    #异步通知url，商户根据实际开发过程设定
    NOTIFY_URL = "https://www.zcdata.com.cn/jcbpay/ajax/purchase_complete_by_the_third/"
...
class OrderQuery_pub(Wxpay_client_pub):
    ...
    def createXml(self):
        ...
        #检测必填参数
        #微信官网中 out_trade_no transaction_id任选一 
        ...
        self.parameters["appid"] = WxPayConf_pub.APPID  #公众账号I
        self.parameters["mch_id"] = WxPayConf_pub.MCHID  #商户号
        self.parameters["nonce_str"] = self.createNoncestr()  #随机字符串
        self.parameters["sign"] = self.getSign(self.parameters)  #签名
        return  self.arrayToXml(self.parameters)
